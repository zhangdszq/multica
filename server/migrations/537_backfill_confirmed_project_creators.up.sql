-- SHUZ-152: persist creator attribution confirmed by the workspace owner.
-- The workspace and project UUID guards make this a no-op in other deployments.
UPDATE project
SET created_by = CASE
    WHEN id IN (
        '7181cff2-8d1f-4cb4-9cae-c4959cf4c697'::uuid,
        'e4f36ec8-3c67-47d5-a2c2-08f458efb1af'::uuid
    ) THEN 'b4a22a55-a3aa-499e-b33e-26de4b8fc65a'::uuid
    ELSE 'a01b5b0c-0491-4186-a8c4-f33f25f834c9'::uuid
END
